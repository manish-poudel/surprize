    ...
    return Column(
      ...
      children: <Widget>[
       settingMenu("Profile", Icons.perm_identity, () => AppHelper.cupertinoRoute(context, ProfilePage())),
        settingMenu("Terms and conditions",Icons.info, () => AppHelper.cupertinoRoute(context, TermsAndConditionPage())),
        settingMenu("Privacy policy",Icons.data_usage, null),
        settingMenu("FAQ",Icons.question_answer, null),
