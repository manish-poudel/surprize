        ...
        children: <Widget>[
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: Text(_player.name, style: TextStyle(color:  Colors.white, fontFamily: 'Raleway' ,fontSize: 24, fontWeight: FontWeight.w400)),
            ),
          ),
          Visibility(
            ...
            child: Padding(
              ...
              child: Text(_player.email, style: TextStyle(color: Colors.white, fontFamily: 'Raleway' ,fontSize: 14, fontWeight: FontWeight.w400)),
            ),
          ),
        ],
      ),
