...
class DailyQuizChallengeScoreSummaryPageState extends State<DailyQuizChallengeScoreSummaryPage>{
  @override
        ...
        body: Container(
          ...
          child: Column(children: <Widget>[
            ...
            Padding(
              ...
              child: totalScoreHeading((widget._totalScore + 10).toString()),
            ),
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: scoreTypeHeading("Correct answers", widget._totalScore.toString()),
            ),
  ...
  Widget headingText(String text){
    return Padding(
      ...
      child: Text(text, style: TextStyle(fontSize: 35, fontFamily: 'Roboto', color: Colors.white)),
    );
  }
  ...
  Widget scoreSummaryText(){
   return Container(
        width: MediaQuery.of(context).size.width,
        decoration: BoxDecoration(
            color: Colors.purple[900], shape: BoxShape.circle
        ),
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Center(child: Text("Score Summary", style: TextStyle(fontSize: 35, fontFamily: 'Roboto', color: Colors.white))),
        ));
  }
    ...
    return Container(
      ...
      child: Row(children: <Widget>[
        ...
        Padding(
          ...
          child: Text(score, style: TextStyle(color: Colors.white, fontSize: 18.0,
              fontFamily: 'Roboto')),
        ),
      ]),
    );
      ...
      child: Center(
        child: Container(
          ...
          child: Center(
            child: Text(
                totalScore,
              style: TextStyle(color: Colors.white, fontSize:90,fontFamily: 'Roboto'),
            ),
          ),
        ),
      ),
    ...
    return FlatButton(
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Row(children: <Widget>[
            Expanded(child: Text(text, style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Roboto'))),
        ...
        child: Row(
          children: <Widget>[
            Expanded(child: Padding(
              ...
              child: Text("Total Score", style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Roboto')),
            )),
            Text(score, style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Roboto'))
          ],
        ),
      ),
    );
