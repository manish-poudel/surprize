...
class LoginPageState extends State<LoginPage> {
  ...
  void loginUser() {
    ...
    _customProgressBarWidget.startProgressBar(
        context,
        StringResources.loginProgressInformationDisplay,
        Colors.white,
        Colors.black);
    FirestoreOperations()
        .loginUser(_emailField.getValue().trim(), _passwordField.getValue())
        .then((firebaseUser) {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 16.0),
                      child: FlatButton(
                          child: Text(StringResources.buttonLoginText,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 18,
                                  fontFamily: 'Raleway')),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: FlatButton(
                            color: Colors.green,
                            onPressed: () => AppHelper.cupertinoRoute(
                                context, RegistrationOptionPage()),
